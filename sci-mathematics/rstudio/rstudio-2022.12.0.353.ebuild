...
ELECTRON_EGIT_COMMIT="7d165dcfc1b6d300eb247738db2c7076234f6ef0"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-2022.12.0.353-node_electron_cmake.patch"
	...
	"${FILESDIR}/${PN}-2022.12.0.353-postback.patch"
)
