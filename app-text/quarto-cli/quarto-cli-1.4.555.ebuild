...
src_unpack() {
	...
	edit_deno_pkg_reg "rollup@2.79.1" '.versions.[$ver].optionalDependencies |= . + {"fsevents":"~2.3.3"}'
	edit_deno_pkg_reg "vite@3.2.10" '.versions.[$ver].optionalDependencies |= . + {"fsevents":"~2.3.3"}'
	edit_deno_pkg_reg "fsevents@2.3.3" '.versions.[$ver] |= . + {"os":["darwin"],"cpu":[]}'
}
src_prepare() {
