...
EAPI=8
#v8-0.43.1-clang_llvm14.patch should make this ebuild for clang/llvm v14
#I belive w/o this patch it would compile for the currently unreleased clang/llvm v15
LLVM_MAX_SLOT=14
CRATES="
	Inflector-0.11.4
	...
	deno_ast-0.15.0
	deno_bench_util-0.50.0
	deno_broadcast_channel-0.50.0
	deno_console-0.56.0
	deno_core-0.138.0
	deno_crypto-0.70.0
	deno_doc-0.35.0
	...
	deno_webgpu-0.57.0
	deno_webidl-0.56.0
	deno_websocket-0.61.0
	deno_webstorage-0.51.0
	der-0.4.5
	derive_more-0.99.17
	diff-0.1.12
	digest-0.9.0
...
pkg_postinst(){
	ewarn "cargo ebuild noted one vulnerabilities"
